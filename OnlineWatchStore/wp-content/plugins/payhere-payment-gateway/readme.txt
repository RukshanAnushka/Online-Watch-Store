...
Please upgrade to 1.0.9 for the latest bug fixes and features.
...
2. PayHere listed as a payment method at WooCommerce checkout page
3. PayHere On-site checkout demonstration